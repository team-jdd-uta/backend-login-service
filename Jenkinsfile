...
"""
  ...
  environment {
    ...
    IMAGE_PREFIX = 'team9-'
    IMAGE_NAME = 'login-service'
    DOCKER_CONTEXT = 'loginservice'
    DOCKERFILE = 'loginservice/Dockerfile'
    PLATFORM = 'linux/amd64'
    TEST_COMMAND = 'cd loginservice && ./gradlew test'
